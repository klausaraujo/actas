						...
						<div class="iq-card-body">
							<form method="post" id="form_actas" class="form">
								...
								<div class="form-row">
									...
									<div class="col-12 row mt-2">
										<label class="control-label col-md-2 align-self-center mb-0" for="tolerancia">D&iacute;as Tolerancia:</label>
										<div class="col-md-1">
											<div class="row">
												<input type="text" class="form-control form-control-sm num" maxlength="2" name="tolerancia" id="tolerancia" />
											</div>
										</div>
									</div>
