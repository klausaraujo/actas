					<div class="col-12 iq-card my-3">
						<div class="iq-card-header d-flex justify-content-between">
							<div class="iq-header-title"><h4>Edici&oacute;n de Actas</h4></div>
						</div>
							...
							<form method="post" id="form_actas" action="<?=base_url()?>actas/registrar" class="form">
								...
								<div class="form-row">
									<div class="col-12 row">
										...
										<div class="col-md-2">
											<div class="row">
												...
												<?	foreach($anio as $row): ?>
													<option value="<?=$row->anio;?>" <?=($row->anio === $acta->anio? 'selected': '')?>><?=$row->anio;?></option>
												<?	endforeach; ?>
												</select>
											</div>
										</div>
									...
									<div class="col-12 row mt-2">
										...
										<div class="col-md-6">
											<div class="row">
												<textarea class="form-control mayusc" name="descripcion" required=""><?=$acta->descripcion?></textarea>
									...
									<div class="col-12 row mt-2">
										...
										<div class="col-md-3">
											<div class="row">
												<input type="date" class="form-control" value="<?=$acta->fecha?>"
								...
								<div class="col-sm-12 mx-auto pb-2">
									<button type="submit" class="btn btn-sabogal ml-3 mr-4" id="btnEnviar">Editar Acta</button>
