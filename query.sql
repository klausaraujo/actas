...
DROP TABLE IF EXISTS acta_acuerdos;
...
CREATE TABLE permiso  (
  ...
  PRIMARY KEY (idpermiso),
	...
	INSERT INTO permiso(idpermiso,descripcion,tipo,orden,idmodulo) VALUES(5,'Editar Acta','1',5,2);
	INSERT INTO permiso(idpermiso,descripcion,tipo,orden,idmodulo) VALUES(6,'Listar Acuerdos','1',6,2);
	INSERT INTO permiso(idpermiso,descripcion,tipo,orden,idmodulo) VALUES(7,'Anular Acta','1',7,2);
	INSERT INTO permiso(idpermiso,descripcion,tipo,orden,idmodulo) VALUES(8,'Ver Reporte','1',8,2);
...
CREATE TABLE menu  (
  ...
  PRIMARY KEY (idmenu),
	...
	/*Menus del Módulo de Gestion de Actas*/
	INSERT INTO menu(idmenu,idmodulo,descripcion,nivel,url,icono) VALUES(3,2,'Lista Actas','0','actas','fa fa-list');
	INSERT INTO menu(idmenu,idmodulo,descripcion,nivel,url,icono) VALUES(4,2,'Nuevo Registro','0','nuevaacta','fa fa-pencil-square-o');
...
CREATE TABLE menu_detalle  (
  ...
  PRIMARY KEY (idmenudetalle),
	...
	INSERT INTO menu_detalle (idmenudetalle,idmenu,descripcion,url,icono,orden) VALUES(1,2,'Reporte Acuerdos','#','fa fa-th-list',1);
...
CREATE TABLE acta (
  ...
  idusuario_edicion smallint(4),
  fecha_edicion datetime,
  idusuario_anulacion smallint(4),
  fecha_anulacion datetime,
  activo char(1) DEFAULT '1',
  PRIMARY KEY (idacta)) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci;
  
  CREATE TABLE acta_acuerdos (
  idacuerdo smallint(4) NOT NULL AUTO_INCREMENT,
  idacta smallint(4) NOT NULL,
  correlativo smallint(4) NOT NULL,
  acuerdo varchar(1000),
  ...
  FOREIGN KEY (idacta) REFERENCES acta (idacta) ON DELETE CASCADE ON UPDATE CASCADE)ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci;
